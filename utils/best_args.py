...
best_args = {
    ...
    'seq-cifar10': {'sgd': {-1: {'lr': 0.1,
                    ...
                    'icarl': {50: {'lr': 0.1,
                              ...
                              5120: {'lr': 0.03,
                                     ...
                                     'n_epochs': 50}},
                    'lucir': {
                        200: {'lr': 0.03, 'lr_finetune': 0.01, 'optim_mom': 0.9, 'optim_wd': 0, 'lamda_base': 5,
                              'k_mr': 2, 'fitting_epochs': 20, 'mr_margin': 0.5, 'lamda_mr': 1., 'n_epochs': 50,
                              'batch_size': 32},
                        500: {'lr': 0.03, 'lr_finetune': 0.01, 'optim_mom': 0.9, 'optim_wd': 0, 'lamda_base': 5,
                              'k_mr': 2, 'fitting_epochs': 20, 'mr_margin': 0.5, 'lamda_mr': 1., 'n_epochs': 50,
                              'batch_size': 32},
                        5120: {'lr': 0.03, 'lr_finetune': 0.01, 'optim_mom': 0.9, 'optim_wd': 0, 'lamda_base': 5,
                               'k_mr': 2, 'fitting_epochs': 20, 'mr_margin': 0.5, 'lamda_mr': 1., 'n_epochs': 50,
                               'batch_size': 32},
                    },
                    'fdr': {200: {'lr': 0.03,
    ...
    'seq-cifar100': {
        ...
        'er': {
            100: {'lr': 0.1, 'optim_mom': 0, 'optim_wd': 0, 'minibatch_size': 32, 'batch_size': 32, 'n_epochs': 50},
            200: {'lr': 0.1, 'optim_mom': 0, 'optim_wd': 0, 'minibatch_size': 32, 'batch_size': 32, 'n_epochs': 50},
            500: {'lr': 0.1, 'optim_mom': 0, 'optim_wd': 0, 'minibatch_size': 32, 'batch_size': 32, 'n_epochs': 50},
            2000: {'lr': 0.1, 'optim_mom': 0, 'optim_wd': 0, 'minibatch_size': 32, 'batch_size': 32, 'n_epochs': 50}
        },
        'gdumb': {
        ...
        'icarl': {
            100: {'lr': 0.3, 'optim_mom': 0, 'optim_wd': 1e-05},
            200: {'lr': 0.3, 'optim_mom': 0, 'optim_wd': 1e-05},
            500: {'lr': 0.3, 'optim_mom': 0, 'optim_wd': 1e-05},
            1000: {'lr': 0.3, 'optim_mom': 0, 'optim_wd': 1e-05},
            2000: {'lr': 0.3, 'optim_mom': 0, 'optim_wd': 1e-05},
            5120: {'lr': 0.3, 'optim_mom': 0, 'optim_wd': 1e-05}
        },
        'bic': {
        ...
        'der': {
            500: {'lr': 0.03, 'optim_mom': 0, 'optim_wd': 0, 'alpha': 0.3, 'minibatch_size': 32, 'batch_size': 32, 'n_epochs': 50},
            2000: {'lr': 0.03, 'optim_mom': 0, 'optim_wd': 0, 'alpha': 0.3, 'minibatch_size': 32, 'batch_size': 32, 'n_epochs': 50}
        },
        'derpp': {
            100: {'lr': 0.03, 'optim_mom': 0, 'optim_wd': 0, 'alpha': 0.1, 'beta': 0.5,
                  'minibatch_size': 32, 'batch_size': 32, 'n_epochs': 50},
            200: {'lr': 0.03, 'optim_mom': 0, 'optim_wd': 0, 'alpha': 0.1, 'beta': 0.5,
                  'minibatch_size': 32, 'batch_size': 32, 'n_epochs': 50},
