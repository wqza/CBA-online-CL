...
class CLSER(ContinualModel):
    # In origin code, the author concat the new and buffer samples and feed them
    # to the network together, which leads to lower performance because of BN statistics.
    # So we modified the code by feeding the new and buffer samples separately.
    NAME = 'clser'
