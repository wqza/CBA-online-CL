...
def fill_buffer(self, mem_buffer: Buffer, dataset, t_idx: int) -> None:
        ...
        for x, y, not_norm_x in loader:
            ...
            feats = self.net(norm_trans(not_norm_x), returnt='feature')
            outs = self.net.fc(feats)
...
class ICarl(ContinualModel):
    ...
    def forward(self, x):
        ...
        feats = self.net(x, returnt='feature')
    ...
    def get_loss(self, inputs: torch.Tensor, labels: torch.Tensor,
        ...
        if task_idx == 0:
            ...
            targets = self.eye[labels.long()][:, :ac]
        ...
        for _y in self.classes_so_far:
            ...
            with bn_track_stats(self, False):
                ...
                while len(x_buf):
                    ...
                    feats = self.net(batch, returnt='feature').mean(0)
                    if allt is None:
                        allt = feats
                    else:
                        allt += feats
